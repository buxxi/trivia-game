...
class TriviaServer {
	...
	start() {
		...
		app.use('/trivia/client/js/ext/uuid.mjs', express.static('node_modules/uuid/dist/esm-browser/uuid.mjs'));
		...
		app.use('/trivia/monitor/js/ext/uuid.mjs', express.static('node_modules/uuid/dist/esm-browser/uuid.mjs'));
